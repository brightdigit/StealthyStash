...
struct LegacyKeychainRepository: LegacyCredentialRepository {
  init(defaultServiceName: String, defaultServerName: String, defaultAccessGroup: String? = nil, defaultSynchronizable: Bool? = nil) {
  ...
  func addItem(_ item: LegacyCredentialItem) throws {
    let dictionaryAny = [
      ...
      kSecAttrSynchronizable as String: item.isSynchronizable ?? defaultSynchronizable
    ] as [String: Any?]
